...
export const meta = {
  ...
  tint: '#b8a2d8',
  hints: [
    { text: 'Плочите се плъзгат само в празното място, и то само отстрани — не по диагонал. Подреди <b>1 2 3</b> отгоре, после <b>4 5 6</b>, и накрая долния ред се нарежда сам.',
      done: d => !!d.opened },
    { text: 'Когато вече си сложил горния ред, не го пипай повече: върти останалите шест плочи в кръг около празното.',
      done: d => !!d.opened },
    { text: 'Последните три (7 · 8 и празното) се решават с въртене на долните две редици — ако заседнеш, разбъркай долните шест и започни оттам, без да пипаш горния ред.',
      done: d => !!d.opened },
  ],
};
