...
export const meta = {
  ...
  tint: '#a8b8a0',
  hints: [
    'Всяка буква е една и съща цифра навсякъде. Различните букви са различни цифри. Първата буква на дума не може да е 0.',
    'Петцифрено число, удвоено, дава шестцифрено — значи <b>С = 1</b>, а <b>П</b> е поне 5. Последната цифра: Ч + Ч завършва на Н.',
    'Тръгни от П: 2·П дава СП, тоест 1 и П. Само една цифра върши работа — <b>П = 9</b>. Оттам А, З, Ч се подреждат едно по едно.',
  ],
};
