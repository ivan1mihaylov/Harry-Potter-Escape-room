...
export const meta = {
  ...
  tint: '#7fa8c8',
  hints: [
    'Забранените двойки важат само за брега, <b>на който те няма</b>. Докато си там, никой никого не изяжда.',
    '«Страхът от тъмното» не понася три от останалите, «Последното сбогом» — още две. Значи тези двамата трябва да пътуват заедно или да стоят при теб.',
    'Седем курса стигат: <b>Страхът + Сбогото</b> отсреща → връщаш <b>Страха</b> → пренасяш <b>Едно име + Нощта</b> → връщаш се <b>сам</b> → пренасяш <b>Обичта + Морето</b> → връщаш <b>Сбогото</b> → пренасяш <b>Страха + Сбогото</b>.',
  ],
};
