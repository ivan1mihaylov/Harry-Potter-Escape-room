...
export const meta = {
  ...
  eyebrow: 'Зала VI',
  title: 'Списъкът',
  sub: 'Регистърът е разграфен, но празен. Отстрани, на отделен лист, писарят е нахвърлял осем бележки — и е избягал, преди да ги препише.',
  rune: 'Е',
  bg: 'off',
  tint: '#c8b48f',
  hints: [
    'Започни с двете сигурни бележки: сухото цвете е в килия 3, «името на майка му» — в килия 1. Всичко останало виси на тях.',
    '«В една килия» значи, че двете неща са в един и същ стълб. «През една килия» значи, че между тях стои точно един стълб — тоест разстоянието е <b>две</b>. «През две» значи разстояние <b>три</b>.',
    'Травърс е в килия 1. Оттам нататък бележка 6 («първата целувка е вляво от Долохов») подрежда Роули и Долохов, а Селуин остава последен.',
  ],
};
