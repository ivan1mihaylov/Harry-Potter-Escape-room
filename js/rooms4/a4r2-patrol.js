...
export const meta = {
  ...
  tint: '#8f9fc8',
  hints: [
    { text: 'Студът се усеща <b>една клетка около</b> диментора — на плочата му и на четирите ѝ съседки. Червените плочи на картата показват къде ще е студът <b>след следващия ти ход</b>.',
      done: d => !!d.crossed },
    /* тази носи и отговора на втората стъпка (осемте хода) — затова не я гасим */
