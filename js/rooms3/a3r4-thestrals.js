...
export const meta = {
  ...
  eyebrow: 'Поляна IV',
  title: 'Тестралите',
  sub: 'Поляната мирише на кръв и на кожа. Три тестрала стоят някъде тук — но ти още не си виждал смъртта, значи за теб те са въздух. Въздух, който мачка тревата.',
  rune: 'О',
  grain: null,
  bg: 'off',
  tint: '#8fa0b8',
