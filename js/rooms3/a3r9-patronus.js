...
export const meta = {
  ...
  title: 'Патронусът',
  sub: 'Дърветата се затварят в кръг и оставят една-единствена празнина — колкото да мине светлина. Гората чака да ѝ покажеш, че вътре в теб още свети нещо.',
  rune: null,
  grain: null,
  bg: 'dim',
  tint: '#dfe8ff',
  ...
  MEMORIES.forEach(m => {
    ...
    b.addEventListener('click', () => {
      ...
      if (m.ok) {
        ...
        setTimeout(() => api.solve('От върха на пръчката излиза сребро. То се събира, изправя се на четири крака и вдига глава с рога като клони.'), 1600);
      } else {
