...
export const meta = {
  ...
  tint: '#e0c07a',
  hints: [
    { text: 'Пясъкът показва само по едно зърно наведнъж. Отвориш ли друго, предишното се затваря и зърната се разместват — но разместването е бавно и можеш да проследиш с поглед кое къде отива.',
      done: d => !!d.yearSet },
    { text: 'Годината се чете и без зърна: последната битка за Хогуортс, втори май. Ако помниш книгата, помниш и годината.',
      done: d => !!d.yearSet },
