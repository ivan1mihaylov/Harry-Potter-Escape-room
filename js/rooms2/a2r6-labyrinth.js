...
export const meta = {
  ...
  sub: 'Подът е застлан с пясъка на Основателите. Перлата на печата не се търкаля — тя се хлъзга, докато не се блъсне. А ямите не прощават.',
  rune: 'Л',
  grain: 9,
  bg: 'off',
  tint: '#6fd8c8',
  hints: [
    ...
    'Начало: <b>север</b> до горе, после <b>изток</b>, после <b>юг</b> — оттам нататък пътят се отваря сам. Най-краткото решение е 13 хлъзгания.',
  ],
};

const N = 9;
const WALLS = ['000100000', '000010010', '000010000', '000010000', '001001000',
               '001000100', '010100001', '010100001', '000110010'];
const HOLES = [[8, 5], [2, 8], [6, 3], [1, 5], [4, 6]];
