...
export const meta = {
  ...
  sub: 'Под подземията има помещение без под и без таван. В него висят стотина отломки от нещо счупено — и те се подреждат само ако застанеш там, където трябва, {име}.',
  rune: 'С',
  grain: 4,
  bg: 'off',
  tint: '#9f8cff',
