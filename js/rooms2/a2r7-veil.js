...
export const meta = {
  ...
  tint: '#9f8cff',
  hints: [
    { text: 'Ключът е име на човек, който пропадна през тази арка пред очите на кръщелника си. Шест букви.',
      done: d => !!d.keyed },
    'Дискът е шифров кръг: върти вътрешния пръстен, докато буквата на ключа застане срещу <b>А</b> от външния. Тогава буквата от шифъра се чете отвън навътре. Ключът се повтаря отначало, щом свърши — първата и седмата буква на шепота се четат с една и съща буква от ключа.',
...
function renderKeyStage(api) {
  ...
  if (!api.data.keyed) {
    ...
    host.innerHTML = `
      <div class="sub-step">
        <p class="panel-title">Ключът е приет</p>
        <p class="muted" style="font-size:.92rem">Сега сам подреди ключа под шепота: първата буква
        на ключа стои под първата буква на шифъра, и така — а щом ключът свърши, започва отначало.
        За всяка двойка върти диска, докато буквата на ключа застане срещу <b>А</b>, и чети
        отвън навътре.</p>
