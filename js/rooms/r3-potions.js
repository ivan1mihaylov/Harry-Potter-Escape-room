...
export const meta = {
  ...
  sub: 'Черен огън пред теб, лилав — зад теб. На масата седем шишенца, {име}, а логиката е единственият ти чадър срещу отровата.',
  rune: 'А',
  bg: 'off',
  tint: '#7bd4a6',
  hints: [
    { text: 'Първо трите въпроса на Снейп от първия урок по отвари. Асфодел и пелин дават най-силната приспивателна отвара; безоарът се вади от стомаха на коза; аконит и клобук на монах са едно и също растение.',
      done: d => !!d.verified },
