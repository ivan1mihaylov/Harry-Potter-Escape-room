...
export const meta = {
  ...
  tint: '#e0b45a',
  hints: [
    'Всеки дом си има свой призрак: Почтибезглавият Ник е на Грифиндор, Сивата дама — на Рейвънклоу, Дебелият монах — на Хафълпаф, Кървавият барон — на Слидерин.',
    'Призраците са ключът: Дебелият монах е на Хафълпаф, Сивата дама — на Рейвънклоу, Почтибезглавият Ник — на Грифиндор, а Кървавият барон — на Слидерин.',
    'От бележките: Хафълпаф е последен, а Сивата дама не е нито втора, нито трета — значи Рейвънклоу води.',
