...
export const meta = {
  ...
  eyebrow: 'Зала IX',
  title: 'Нужната стая',
  sub: 'Между хилядите изгубени вещи лежи една тетрадка с продупчена корица. Мастилото в нея още е мокро — и вече знае как се казваш, {име}.',
  rune: 'А',
  bg: 'dim',
  tint: '#7a5fd0',
  hints: [
    { text: 'Буквите на „TOM MARVOLO RIDDLE“ се пренареждат в изречение на английски от четири думи: 1 + 2 + 4 + 9 букви.',
      done: d => !!d.named },
    { text: 'Изречението започва с „I AM…“. Следват два неща: титла от четири букви и име от девет.',
      done: d => !!d.named },
