...
export const meta = {
  ...
  tint: '#e8d9a8',
  hints: [
    { text: 'Надписът върху рамката се чете в огледало: обърни го отзад напред и разделѝ думите наново.',
      done: d => !!d.spelled },
    { text: 'Деветте руни са букви на едно-единствено заклинание — най-простото, което всеки първокурсник учи, за да отваря заключено.',
      done: d => !!d.spelled },
