/* ============================================================
   ...
   ============================================================ */
import { head, $, $$, el, norm, shakeEl, shuffle } from './common.js';

export const meta = {
  id: 'dada',
  eyebrow: 'Зала VI',
  title: 'Кабинетът по Защита',
  sub: 'Гардеробът в ъгъла трепери. Вътре има богърт, който вече е научил осемте неща, от които се страхуваш. Имаш пръчка, три сърца и много малко време.',
  rune: 'М',
  bg: 'dim',
  tint: '#c86a6a',
  hints: [
    'Заклинанията в дясната колона са точно колкото трябват плюс няколко примамки. Прочети опасността и си спомни какво прави всяко заклинание.',
    'Тъмнина → Люмос. Ключалка → Алохомора. Насочена пръчка → Експелиармус. Счупено стъкло → Окулус Репаро.',
...
function finish(api) {
  ...
  setTimeout(() => api.solve('Осем страха, осем заклинания. Върху дръжката на гардероба е издълбана руна.'), 700);
}
