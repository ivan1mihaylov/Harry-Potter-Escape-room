...
export const meta = {
  ...
  eyebrow: 'Зала I',
  title: 'Перон 9¾',
  sub: 'Гара Кингс Крос, 23:58. Влакът за Хогуортс още диша пара някъде оттатък тухлите, {име} — трябва само да намериш пролуката.',
  rune: 'О',
  bg: 'dim',
  tint: '#c9a34a',
  hints: [
    { text: 'Перонът на магьосниците не е нито девети, нито десети. Той е между тях — потърси колоната, а не табелата.',
      done: d => (d.stage || 0) >= 1 },
    { text: 'Даровете на Смъртта са три: Бъзовата пръчка, Възкресяващият камък и Мантията невидимка. Пухчо има три глави.',
      done: d => (d.stage || 0) >= 1 },
