/* ============================================================
   ...
   Настройката е FORM по-долу: адресът на формата и кое
   entry.* поле кое е. Ако някога смениш формата, вземи ѝ
   предварително попълнената връзка («Get pre-filled link»,
   с 1…8 в осемте въпроса) — в нея пише всеки entry номер.
   ============================================================ */

/* ---------- НАСТРОЙКА ---------- */
export const FORM = {
  url: 'https://docs.google.com/forms/d/e/1FAIpQLSdV1r5aKoBxOKHvZOnfnHLOsef3SynCS2_Z_Risj1c3wpAqdQ/formResponse',
  fields: {
    name: 'entry.340271155', act: 'entry.2104109856', seconds: 'entry.90433710',
    mistakes: 'entry.2081722009', hints: 'entry.202912976', grade: 'entry.845473515',
    house: 'entry.2127530760', date: 'entry.1630337751',
  },
};
