...
export const meta = {
  ...
  tint: '#8a7fc0',
  hints: [
    'Кабината не звъни на никого — тя <b>слиза</b>. Кодът е пет цифри и Артър Уизли го набира всеки ден.',
    'На стара телефонна шайба всяка цифра носи по три букви: 2=ABC, 3=DEF, 4=GHI, 5=JKL, 6=MNO, 7=PQRS, 8=TUV, 9=WXYZ.',
