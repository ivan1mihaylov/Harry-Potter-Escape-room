...
export const ACTS = {
  ...
  5: {
    ...
    tagline: 'девет камери · осем руни · шестдесет минути · нищо тук не се обяснява',
    spell: 'ИНСЕНДИО',
    ...
    load: () => Promise.all([
      import('./rooms5/a5r1-entry.js'),
      import('./rooms5/a5r2-doors.js'),
      import('./rooms5/a5r3-brains.js'),
      import('./rooms5/a5r4-time.js'),
      import('./rooms5/a5r5-planets.js'),
      import('./rooms5/a5r6-death.js'),
