...
export function howTo() {
  openModal(`
    ...
    <ul style="padding-left:1.2em;line-height:1.75">
      <li><b>Шест части.</b> Първа част е десет зали; следващите са по девет.
        Всяка се отключва само с оценка <b>«Изключителна»</b> в предишната — цялата,
        за под 32 минути.</li>
      <li><b>Всяка решена зала дава руна.</b> Накрая руните се нареждат в едно заклинание:
        АЛОХОМОРА, ФИДЕЛИУС, ПАТРОНУС, ОКЛУМЕНС, ИНСЕНДИО, ХОРКРУКС.</li>
      <li><b>Име и дом.</b> Питат се веднъж, в началото на Първа част. Оттам нататък
        играта се обръща към теб по име. Махат се само с «Изтрий всичко».</li>
      <li><b>Шестдесет минути</b> на част. Часовникът тече само докато играеш и се пази
        между посещенията.</li>
      <li><b>Подсказки.</b> Бутонът с крушката дава по една срещу <b>2 минути</b>.
        В зала с няколко стъпки минеш ли стъпка сам, подсказката за нея се отбелязва
        като изминала и не се плаща — предлага ти се направо следващата, която върши работа.</li>
      <li><b>Грешките болят.</b> Някои погрешни действия отнемат по 30 секунди или повече.</li>
      <li><b>Бележникът</b> (иконата с листа) пази записките ти — ще ти трябва.</li>
      <li><b>Зърната пясък</b> (само във Втора част) са цифри и се четат в Хроноворота.</li>
      <li><b>Оглед.</b> Десет клика върху катинара на заключена част я отварят само за
        разглеждане: нищо не се записва и частта си остава заключена.</li>
      <li><b>Статистиката</b> събира всички пробези — твоите и чуждите, ако са изпратени.</li>
    </ul>
    <p class="muted">Съвет: почти всяка загадка има връзка със света на Хари Потър.
    Ако си спомниш книгата — печелиш минути.</p>
